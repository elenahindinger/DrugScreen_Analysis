...
def intogroups(fish1, fish2, fish3, fish4, fish5, fish6, fish7, fish8):
    ...
    fi7 = ['fish7'] * 4
    fi8 = ['fish8'] * 4
    group = list(it.chain(fi1, fi2, fi3, fi4, fi5, fi6, fi7, fi8))
    # create concat
...
def ind_csv(gr_ctr_in, het_ctr_in, gr_com_in, het_com_in, filepath):
    ...
    gr_com_tp1 = gr_com.get_group('tp1').set_index(np.arange(8))
    gr_com_tp2 = gr_com.get_group('tp2').set_index(np.arange(8))
    gr_com_tp3 = gr_com.get_group('tp3').set_index(np.arange(8))
    gr_com_tp4 = gr_com.get_group('tp4').set_index(np.arange(8))
    het_com_tp1 = het_com.get_group('tp1').set_index(np.arange(8))
    het_com_tp2 = het_com.get_group('tp2').set_index(np.arange(8))
    het_com_tp3 = het_com.get_group('tp3').set_index(np.arange(8))
    het_com_tp4 = het_com.get_group('tp4').set_index(np.arange(8))
    # concat per tp
