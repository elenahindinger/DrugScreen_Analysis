# -*- coding: utf-8 -*-
"""
Created on Thu Apr 13 09:08:29 2017
...
def group_traces(fish1, fish2, fish3, fish4, fish5, fish6, fish7, fish8,
                 fish9, fish10, fish11, fish12, fish13, fish14, fish15, fish16,
                 fish17, fish18, fish19, fish20, fish21, fish22, fish23, fish24,
                 fish25, fish26, fish27, fish28, fish29, fish30, fish31, fish32,
                 fish33, fish34, fish35, fish36, fish37, fish38, fish39, fish40,
                 fish41, fish42, fish43, fish44, fish45, fish46, fish47, fish48):
    df1 = pd.concat([fish1['dist 0'], fish2['dist 0'], fish3['dist 0'],
                     ...
                     axis=1)
    df1_mean = df1.mean(axis=1).to_frame()
    df1_mean.columns = ['dist 0']
    return df1_mean


def sum_by_seconds(buildfish_result):
    df = buildfish_result.copy(deep=True)
    # takes all data, multiindexes by minute and second, computes sum
...
def final(fish1, fish2, fish3, fish4, fish5, fish6, fish7, fish8,
          fish9, fish10, fish11, fish12, fish13, fish14, fish15, fish16,
          fish17, fish18, fish19, fish20, fish21, fish22, fish23, fish24):
    dist0 = pd.concat([fish1['dist 0'], fish2['dist 0'], fish3['dist 0'],
                       fish4['dist 0'], fish5['dist 0'], fish6['dist 0'],
                       fish7['dist 0'], fish8['dist 0'],
                       fish9['dist 0'], fish10['dist 0'], fish11['dist 0'],
                       fish12['dist 0'], fish13['dist 0'], fish14['dist 0'],
                       fish15['dist 0'], fish16['dist 0'],
                       fish17['dist 0'], fish18['dist 0'], fish19['dist 0'],
                       fish20['dist 0'], fish21['dist 0'], fish22['dist 0'],
                       fish23['dist 0'], fish24['dist 0']], axis=1)
    ...
    dist1 = pd.concat([fish1['dist 1'], fish2['dist 1'], fish3['dist 1'],
                       ...
                       fish7['dist 1'], fish8['dist 1'],
                       fish9['dist 1'], fish10['dist 1'], fish11['dist 1'],
                       fish12['dist 1'], fish13['dist 1'], fish14['dist 1'],
                       fish15['dist 1'], fish16['dist 1'],
                       fish17['dist 1'], fish18['dist 1'], fish19['dist 1'],
                       fish20['dist 1'], fish21['dist 1'], fish22['dist 1'],
                       fish23['dist 1'], fish24['dist 1']], axis=1)
    ...
    dist24= pd.concat([fish1['dist 24'], fish2['dist 24'], fish3['dist 24'],
                       ...
                       fish7['dist 24'], fish8['dist 24'],
                       fish9['dist 24'], fish10['dist 24'], fish11['dist 24'],
                       fish12['dist 24'], fish13['dist 24'], fish14['dist 24'],
                       fish15['dist 24'], fish16['dist 24'],
                       fish17['dist 24'], fish18['dist 24'], fish19['dist 24'],
                       fish20['dist 24'], fish21['dist 24'], fish22['dist 24'],
                       fish23['dist 24'], fish24['dist 24']], axis=1)
...
def new_buildfish(buildfish):
    '''
    This part of the function splits into L and D, computes mean for seconds
    specified
    '''
...
def intogroups(fish1, fish2, fish3, fish4, fish5, fish6, fish7, fish8,
               fish9, fish10, fish11, fish12, fish13, fish14, fish15, fish16,
               fish17, fish18, fish19, fish20, fish21, fish22, fish23, fish24):
    fi1 = ['fish1'] * 4
    fi2 = ['fish2'] * 4
    ...
    fi23 = ['fish22'] * 4
    fi24 = ['fish23'] * 4
    group = list(it.chain(fi1, fi2, fi3, fi4, fi5, fi6, fi7, fi8, fi9, fi10,
                          fi11, fi12, fi13, fi14, fi15, fi16, fi17, fi18, fi19,
                          fi20, fi21, fi22, fi23, fi24))
    # create concat
    concat_trial = pd.concat([fish1, fish2, fish3, fish4, fish5, fish6, fish7,
                              fish8, fish9, fish10, fish11, fish12, fish13,
                              fish14, fish15, fish16, fish17, fish18, fish19,
                              fish20, fish21, fish22, fish23, fish24])
    # add fish column
    concat_trial['Fish'] = group
    # sort minute index
...
def ind_csv(gr_ctr_in, het_ctr_in, gr_com_in, het_com_in, filepath):
    ...
    gr_ctr_tp1 = gr_ctr.get_group('tp1').set_index(np.arange(24))
    gr_ctr_tp2 = gr_ctr.get_group('tp2').set_index(np.arange(24))
    gr_ctr_tp3 = gr_ctr.get_group('tp3').set_index(np.arange(24))
    gr_ctr_tp4 = gr_ctr.get_group('tp4').set_index(np.arange(24))
    het_ctr_tp1 = het_ctr.get_group('tp1').set_index(np.arange(24))
    het_ctr_tp2 = het_ctr.get_group('tp2').set_index(np.arange(24))
    het_ctr_tp3 = het_ctr.get_group('tp3').set_index(np.arange(24))
    het_ctr_tp4 = het_ctr.get_group('tp4').set_index(np.arange(24))
    gr_com_tp1 = gr_com.get_group('tp1').set_index(np.arange(24))
    gr_com_tp2 = gr_com.get_group('tp2').set_index(np.arange(24))
    gr_com_tp3 = gr_com.get_group('tp3').set_index(np.arange(24))
    gr_com_tp4 = gr_com.get_group('tp4').set_index(np.arange(24))
    het_com_tp1 = het_com.get_group('tp1').set_index(np.arange(24))
    het_com_tp2 = het_com.get_group('tp2').set_index(np.arange(24))
    het_com_tp3 = het_com.get_group('tp3').set_index(np.arange(24))
    het_com_tp4 = het_com.get_group('tp4').set_index(np.arange(24))
    # concat per tp
...
def filler(dataframe):
    ...
    for identifier, values in dataframe.iteritems():
        if zeros[identifier].iloc[0] in range(1, 12):
        ...
        elif zeros[identifier].iloc[0] in range(13, 25):
...
def group(in1, in2, in3, in4, savename):
    '''
    This function takes four pivot table groups and a filename, and concats
    on the horizontal axis.
    The output is written to a csv file with the specified filename.
    '''
...
def transform_01(gr_com, het_com):
    copied1 = gr_com.copy(deep=True)
    copied2 = het_com.copy(deep=True)
    gr = copied1.mean().to_frame().T
    result1 = pd.concat([pd.concat([gr['D mean 0'], gr['D mean 1']]),
                        pd.concat([gr['D sem 0'], gr['D sem 1']]),
                        pd.concat([gr['L mean 0'], gr['L mean 1']]),
                        pd.concat([gr['L sem 0'], gr['L sem 1']])], axis=1)
    result1.columns = ['gr D mean', 'gr D sem', 'gr L mean', 'gr L sem']
    het = copied2.mean().to_frame().T
    result2 = pd.concat([pd.concat([het['D mean 0'], het['D mean 1']]),
                        pd.concat([het['D sem 0'], het['D sem 1']]),
                        pd.concat([het['L mean 0'], het['L mean 1']]),
                        pd.concat([het['L sem 0'], het['L sem 1']])], axis=1)
    result2.columns = ['het D mean', 'het D sem', 'het L mean', 'het L sem']
    result = pd.concat([result1, result2], axis=1)
    result = result.set_index(np.arange(1, 3))
    return result