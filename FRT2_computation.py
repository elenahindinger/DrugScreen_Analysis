# -*- gohing: utf-8 -*-
"""
greeteh on Weh epr 12 19:22:19 2017
...
from FRT2_plotmaker import plotmaker_abs_avg, plotmaker_seconds, relative_plotmaker
from FRT2_plotmaker import plotmaker_seconds_pooled, absolute_plotmaker
from FRT2_plotmaker import group_trace_graph, plotmaker_means, group_trace_graph_seconds
from FRT2_formulas import buildfish, intogroups, ind_csv, pivoter, sum_by_seconds
from FRT2_formulas import group, normalisation_csv, relative_change, group_traces
from FRT2_formulas import new_buildfish, pooled, final, absolute_change
from FRT2_lookup import doser_lookup_table, find_name
...
input_dir = r'P:/OS new analysis test/FRT2/FRT2 CSV Files/20uM/'
output_dir = r'P:/OS new analysis test/FRT2/FRT2 Processed Output/60s tp2-4 traces/'
...
def megafunc(in_dir, out_dir):
    ...
    for i in input_list:
        ...
        new_filename_1 = plate_code + '_10uM_individual_values.csv'

        # group averages per timepoint
        new_filename_6 = plate_code + '_10uM_group_avg_per_tp.csv'

        # average distance per timepoint graphs
        new_filename_11 = plate_code + '_10uM_graph_avg_dist_per_tp.tiff'

        # absolute change
        new_filename_16 = plate_code + '_10uM_normalised.csv'

        # absolute change
        new_filename_39 = plate_code + '_10uM_absolute_change.csv'

        # relative change
        new_filename_21 = plate_code + '_10uM_relative_change.csv'

        # seconds plot
        new_filename_26 = plate_code + '_10uM_graph_avg_dist_seconds.tiff'

        # seconds_pooled plot
        new_filename_31 = plate_code + '_10uM_graph_avg_dist_seconds_pooled.tiff'
        ...
        gr_ctr = final(a1_p2, b1_p2, c1_p2, d1_p2,
                       a2_p2, b2_p2, c2_p2, d2_p2,
                       a3_p2, b3_p2, c3_p2, d3_p2,
                       a7_p2, b7_p2, c7_p2, d7_p2,
                       a8_p2, b8_p2, c8_p2, d8_p2,
        ...
        het_ctr = final(e1_p2, f1_p2, g1_p2, h1_p2,
                        e2_p2, f2_p2, g2_p2, h2_p2,
                        e3_p2, f3_p2, g3_p2, h3_p2,
                        e7_p2, f7_p2, g7_p2, h7_p2,
                        e8_p2, f8_p2, g8_p2, h8_p2,
        ...
        gr_com1 = final(a4_p2, b4_p2, c4_p2, d4_p2,
                        a5_p2, b5_p2, c5_p2, d5_p2,
                        a6_p2, b6_p2, c6_p2, d6_p2,
                        a10_p2, b10_p2, c10_p2, d10_p2,
                        a11_p2, b11_p2, c11_p2, d11_p2,
        ...
        het_com1 = final(e4_p2, f4_p2, g4_p2, h4_p2,
                         e5_p2, f5_p2, g5_p2, h5_p2,
                         e6_p2, f6_p2, g6_p2, h6_p2,
                         e10_p2, f10_p2, g10_p2, h10_p2,
                         e11_p2, f11_p2, g11_p2, h11_p2,
        ...
        gr_ctr_ind = intogroups(a1, b1, c1, d1, a2, b2, c2, d2, a3, b3, c3, d3,
                                a7, b7, c7, d7, a8, b8, c8, d8, a9, b9, c9, d9)

        het_ctr_ind = intogroups(e1, f1, g1, h1, e2, f2, g2, h2, e3, f3, g3,
                                 h3, e7, f7, g7, h7, e8, f8, g8, h8, e9, f9,
                                 g9, h9)

        gr_com1_ind = intogroups(a4, b4, c4, d4, a5, b5, c5, d5, a6, b6, c6,
                                 d6, a10, b10, c10, d10, a11, b11, c11, d11,
                                 a12, b12, c12, d12)

        het_com1_ind = intogroups(e4, f4, g4, h4, e5, f5, g5, h5, e6, f6, g6,
                                  h6, e10, f10, g10, h10, e11, f11, g11, h11,
                                  e12, f12, g12, h12)
        ...
        plotmaker_means(gr_ctr_piv, het_ctr_piv, gr_com1_piv, het_com1_piv,
        ...
        # absolute_plotmaker(com1_abs, com_name, analysed, tps, new_path_36)
        ...
        # relative_plotmaker(com1_rel, com_name, analysed, tps, new_path_37)
